...
export const AGENTS_DATA: AgentData[] = [
  {
    ...
    metrics: [
      ...
      { name: '竞品情报更新', value: '24次/周', change: '0', changeType: 'neutral' },
    ],
  ...
  },
  {
    ...
    metrics: [
      ...
      { name: 'SEO关键词提升', value: 28, unit: '个', change: '+12', changeType: 'positive' },
  ...
  },
  {
    ...
    keyResponsibilities: ['7×24h多语言响应', '智能报价与合同', '客户生命周期管理', '复购与转介绍'],
    recentActivities: [
