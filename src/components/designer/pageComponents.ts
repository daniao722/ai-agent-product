...
export const INDUSTRY_MODULE_CONFIGS: Record<string, IndustryModuleConfig[]> = {
  ...
  'electronics': [
    ...
    { id: 'quality-cert', name: '质量认证/检测报告', required: true },
    { id: 'compatibility', name: '兼容性/适配信息', required: true },
    { id: 'installation-guide', name: '安装/使用指南', required: true },
    { id: 'faq', name: '常见问题FAQ', required: true },
    { id: 'customer-reviews', name: '客户评价/案例见证', required: false },
    { id: 'supply-chain', name: '供应链/产能说明', required: false },
    { id: 'after-sales', name: '售后服务承诺', required: true },
    { id: 'compliance', name: '法规合规声明', required: true },
    { id: 'tech-docs', name: '技术文档下载', required: true },
  ...
  'chemical': [
    ...
    { id: 'safety-notes', name: '安全注意事项', required: true },
    { id: 'compliance', name: '法规合规声明', required: true },
    { id: 'environmental', name: '环保/可持续性说明', required: true },
    { id: 'packaging-logistics', name: '包装与物流信息', required: true },
    { id: 'faq', name: '常见问题FAQ', required: true },
    { id: 'customer-reviews', name: '客户评价/案例见证', required: false },
    { id: 'supply-chain', name: '供应链/产能说明', required: false },
    { id: 'tech-docs', name: '技术文档下载', required: true },
    { id: 'customization', name: '定制服务说明', required: true },
    { id: 'rd-team', name: '研发团队/专利展示', required: false },
    { id: 'cta-inquiry', name: '询盘/购买引导CTA', required: true },
  ],
  'food-beverage': [
    ...
    { id: 'faq', name: '常见问题FAQ', required: true },
    { id: 'customer-reviews', name: '客户评价/案例见证', required: true },
    { id: 'brand-story', name: '品牌故事/企业实力', required: false },
    { id: 'success-cases', name: '合作客户/成功案例', required: true },
    { id: 'after-sales', name: '售后服务承诺', required: false },
    { id: 'cta-inquiry', name: '询盘/购买引导CTA', required: true },
  ],
  'textile': [
    { id: 'product-title', name: '产品标题与核心卖点', required: true },
    ...
    { id: 'product-media', name: '产品图片/视频展示', required: true },
    { id: 'product-scenarios', name: '应用场景/使用案例', required: true },
    { id: 'tech-principle', name: '技术原理/工艺流程', required: false },
    { id: 'quality-cert', name: '质量认证/检测报告', required: true },
    { id: 'ingredients', name: '营养成分/成分说明', required: false },
    { id: 'compliance', name: '法规合规声明', required: true },
    { id: 'environmental', name: '环保/可持续性说明', required: true },
    { id: 'packaging-logistics', name: '包装与物流信息', required: false },
    { id: 'faq', name: '常见问题FAQ', required: true },
    ...
    { id: 'after-sales', name: '售后服务承诺', required: false },
    { id: 'brand-story', name: '品牌故事/企业实力', required: true },
    { id: 'success-cases', name: '合作客户/成功案例', required: false },
    { id: 'cta-inquiry', name: '询盘/购买引导CTA', required: true },
  ],
  'construction-materials': [
    ...
    { id: 'faq', name: '常见问题FAQ', required: true },
    { id: 'customer-reviews', name: '客户评价/案例见证', required: false },
    { id: 'competitive-advantage', name: '对比优势/竞品分析', required: true },
    { id: 'supply-chain', name: '供应链/产能说明', required: true },
    { id: 'customization', name: '定制服务说明', required: false },
    { id: 'after-sales', name: '售后服务承诺', required: true },
    { id: 'maintenance', name: '维护保养指南', required: true },
    { id: 'cta-inquiry', name: '询盘/购买引导CTA', required: true },
  ],
  'energy': [
    { id: 'product-title', name: '产品标题与核心卖点', required: true },
  ...
  'agriculture': [
    ...
    { id: 'tech-principle', name: '技术原理/工艺流程', required: true },
    { id: 'quality-cert', name: '质量认证/检测报告', required: true },
    { id: 'safety-notes', name: '安全注意事项', required: false },
    { id: 'compliance', name: '法规合规声明', required: false },
    { id: 'environmental', name: '环保/可持续性说明', required: true },
    { id: 'installation-guide', name: '安装/使用指南', required: true },
    { id: 'packaging-logistics', name: '包装与物流信息', required: false },
    { id: 'faq', name: '常见问题FAQ', required: true },
...
export const INDUSTRY_NAMES: Record<string, string> = Object.fromEntries(
  INDUSTRY_TEMPLATES.map(t => [t.id, t.name])
);

export const DEFAULT_INDUSTRY_ID = INDUSTRY_TEMPLATES[0].id;
export const DEFAULT_INDUSTRY_NAME = INDUSTRY_TEMPLATES[0].name;

export function isValidIndustryId(industryId: string): boolean {
  return INDUSTRY_TEMPLATES.some(t => t.id === industryId);
}

export function getSafeIndustryName(industryId: string): string {
  return isValidIndustryId(industryId) ? getIndustryName(industryId) : DEFAULT_INDUSTRY_NAME;
}

export function getIndustryModuleConfigs(industryId: string): IndustryModuleConfig[] {
  return INDUSTRY_MODULE_CONFIGS[industryId] || INDUSTRY_MODULE_CONFIGS[DEFAULT_INDUSTRY_ID];
}

export function getRequiredModules(industryId: string): IndustryModuleConfig[] {
  return getIndustryModuleConfigs(industryId).filter(m => m.required);
}

export function getOptionalModules(industryId: string): IndustryModuleConfig[] {
  return getIndustryModuleConfigs(industryId).filter(m => !m.required);
}

export function getIndustryName(industryId: string): string {
  return INDUSTRY_NAMES[industryId] || industryId;
}

export const INDUSTRY_DEFAULT_COMPONENTS: Record<string, string[]> =
  Object.fromEntries(
    Object.entries(INDUSTRY_MODULE_CONFIGS).map(([key, modules]) => [
      key,
      modules.map(m => m.id),
    ])
  );
